        ...
        <tr>
            <td>
                <table width="520px" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" align="center"
                       class="m_-1619213263088667308table_shrink">
                    <tbody>
                    <tr>
                        <td valign="top">
                    ...
                    <tr>
                        <td>
                            <table width="520px" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff"
                                   class="m_-1619213263088667308table_shrink" align="center">
                                <tbody>
                                <tr>
                                    <td style="color:#cccccc;padding-top:20px" valign="top" width="100%">
                                        <hr color="#cccccc" size="1">
                                    </td>
                                </tr>
                                <tr>
