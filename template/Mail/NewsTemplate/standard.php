...
<div style="margin:0!important;padding:0!important">
    ...
    <div style="text-align:center;margin:10px 0 20px"><img style="max-width:100%" src="https://nonstopshop.rs/wp-content/uploads/2018/11/16/47/Potpis.jpg" alt="potpis"></div>
    ...
    <div style="text-align:center;color:#888;margin-top:20px">
        ...
        <div style="text-align:center;margin:10px 0 20px">
            <font size="2">Ukoliko želite da se odjavite sa mejling liste posetite stranicu "Vaš nalog"&nbsp;</font><font size="2">ili,</font>&nbsp;<a href="#unsubscribeUrl" rel="noopener noreferrer" target="_blank">kliknite ovde</a>.</div>
    </div>
